...
export default function Tarjeta({ escuela }) {
  ...
  const fotos =
    Array.isArray(escuela.fotos) && escuela.fotos.length > 0
      ? escuela.fotos
      : [];
  ...
  return (
    <article className="h-full w-full">
      <div className="flex h-full min-h-[580px] w-full flex-col overflow-hidden rounded-[24px] border border-slate-200 bg-white shadow-sm transition duration-300 hover:-translate-y-1 hover:shadow-lg">
        {/* Image / placeholder */}
