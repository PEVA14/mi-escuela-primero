    ...
    >
      <div className="mx-auto w-full max-w-[1280px]">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <h2
            id="movexp"
            className="mt-5 text-3xl font-extrabold tracking-[-0.04em] text-slate-900 md:text-4xl lg:text-5xl"
          >
            Cómo funciona
          </h2>
          <p className="mx-auto mt-4 max-w-3xl text-base leading-8 text-slate-600 md:text-lg">
            Conectamos necesidades reales con aliados comprometidos en 6 pasos
            simples. El proceso es transparente, eficiente y fácil de seguir.
          </p>
        </div>
        ...
        <div className="mx-auto mt-10 max-w-5xl rounded-[24px] border border-emerald-100 bg-emerald-50/60 px-6 py-5 text-center shadow-sm">
          <p className="text-sm leading-7 text-slate-600 md:text-base">
            ...
            Todos tus datos se manejan con total confidencialidad de acuerdo con
            nuestro Aviso de Privacidad. Tu información solo se usa para
            coordinar el apoyo con las escuelas.
          </p>
        </div>
      </div>
    </section>
