  ...
  const cards = [
    {
      icon: school,
      alt: "escuela",
      value: stats.escuelas,
      label: "Escuelas registradas",
    },
    {
      icon: heart,
      alt: "corazon",
      value: stats.necesidades,
      ...
      <div className="mx-auto flex w-full max-w-[1280px] flex-col gap-10">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <p className="mx-auto mt-5 max-w-3xl text-base leading-8 text-emerald-50/90 md:text-lg">
            Plataforma que une escuelas con necesidades específicas y donadores
            comprometidos. Transparente, fácil y con resultados medibles.
          </p>
        </div>
