      ...
      <div className="mx-auto w-full max-w-[1280px]">
        <div className="mx-auto mb-11 max-w-[860px] text-center">
          ...
          <p className="mx-auto mt-6 max-w-[760px] text-[clamp(1rem,1.6vw,1.3rem)] leading-[1.7] text-slate-600">
            Construimos confianza con métricas visibles, seguimiento puntual y
            transparencia en cada etapa del apoyo a las escuelas.
          </p>
        </div>
        ...
        <div className="grid items-start gap-6 rounded-[30px] border border-white/40 bg-white/95 p-8 text-slate-900 shadow-[0_24px_60px_rgba(15,23,42,0.16)] md:grid-cols-[120px_minmax(0,1fr)] md:p-8">
          <div className="mx-auto flex h-24 w-24 items-center justify-center rounded-[28px] bg-gradient-to-b from-emerald-100 to-emerald-200 md:mx-0">
            <img
              ...
              src={transparenci}
              alt="Compromiso con la transparencia"
            />
          </div>
          ...
          <div className="text-center md:text-left">
            ...
            <p className="mt-4 text-base leading-8 text-slate-600">
              En Mi Escuela Primero, nos tomamos muy en serio la confianza que
              depositás en nosotros. Cada donación es rastreada y verificada, y
              proporcionamos informes detallados sobre el impacto de cada
              contribución. Trabajamos directamente con las escuelas para
              asegurar que los recursos lleguen donde realmente se necesitan.
            </p>
